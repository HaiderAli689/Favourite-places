...
class LocationInput extends StatefulWidget {
  const LocationInput({Key? key, required this.onSelectedLocation})
      : super(key: key);
...
class _LocationInputState extends State<LocationInput> {
  ...
  Future<void> _savePlace(double latitude, double longitude) async{
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=4$latitude,-$longitude&key=AIzaSyDPRdzjxGDe28tHL_1NEzSbk3Rw56MZF-k');
  ...
  Widget build(BuildContext context) {
    void _selectOnMap() async {
      ...
      _savePlace(pickedLocation.longitude, pickedLocation.longitude);
    }
